      ...
      >
        ...
        <div>
          ...
          <ul className="mt-3">
            ...
            {/* MyPhotos */}
            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${page === 'my_photos' && 'bg-gray-900'}`}>
              <NavLink exact to="/my_photos" className={`block text-gray-200 hover:text-white transition duration-150 ${page === 'my_photos' && 'hover:text-gray-200'}`}>
                <div className="flex flex-grow">
                  <svg className="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
